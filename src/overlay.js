(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".f2c-pin.f2c-active { background: #f3c94f; color: #0a0a0a; }",

      ".f2c-popover {",
      "  position: absolute; z-index: 9999;",
      "  width: 280px; background: white;",
      "  border: 2px solid #0a0a0a;",
      "  box-shadow: 4px 4px 0 #5a2d56;",
      "  padding: 12px;",
      ...
      "  color: #5a2d56; text-transform: uppercase;",
      ...
      "}",
      ".f2c-popover textarea:focus { outline: 2px solid #5a2d56; outline-offset: -1px; }",
      ...
      "  background: #5a2d56; padding: 4px 8px;",
      ...
      "}",
      ".f2c-toolbar button.f2c-primary { background: #f3c94f; color: #0a0a0a; border-color: #0a0a0a; box-shadow: 2px 2px 0 #0a0a0a; }",
      ".f2c-toolbar button:hover:not(.f2c-primary) { background: #5a2d56; }",
      ".f2c-toolbar button.f2c-primary:hover { background: #f7d878; }",
      ".f2c-toolbar button.f2c-armed-on { background: #5a2d56; color: #fdfaf3; border-color: #fdfaf3; }",
